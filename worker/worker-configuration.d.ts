/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: e60f682d9d932c7a4c916d9a288d6e38)
// Runtime types generated with workerd@1.20260820.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "https://tmayberry.github.io,https://courses.cs.usna.edu,http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173";
	TURN_CREDENTIAL_TTL_SECONDS: "3600";
	PAIR_GRANT_TTL_SECONDS: "600";
	TURN_KEY_ID: string;
	TURN_API_TOKEN: string;
	COURSE_ACCESS_CODE: string;
	PAIR_GRANT_SIGNING_KEY: string;
	PAIRING_SESSIONS: DurableObjectNamespace<import("./index").PairingSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "PairingSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "TURN_CREDENTIAL_TTL_SECONDS" | "PAIR_GRANT_TTL_SECONDS" | "TURN_KEY_ID" | "TURN_API_TOKEN" | "COURSE_ACCESS_CODE" | "PAIR_GRANT_SIGNING_KEY">> {}
}
