...
const PhoneRemote = lazy(() =>
  import("./ui/PhoneRemote").then((module) => ({
    default: module.PhoneRemote,
  })),
);
...
createRoot(document.getElementById("root")!).render(
  <StrictMode>
    <Suspense
      fallback={<div className="app-loading">Loading Arduino Emulator…</div>}
    >
      {phonePairingSessionId ? (
        <PhoneRemote
          sessionId={phonePairingSessionId}
          pairingGrant={phonePairingGrant}
        />
      ) : (
        <DesktopApp />
      )}
